...
static ::_pb::Metadata file_level_metadata_proto_2fsample1_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_proto_2fsample1_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_proto_2fsample1_2eproto = nullptr;

const uint32_t TableStruct_proto_2fsample1_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_proto_2fsample1_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\023proto/sample1.proto\"L\n\rSearchRequest\022\r"
  "\n\005query\030\001 \001(\t\022\023\n\013page_number\030\002 \001(\005\022\027\n\017re"
  "sult_per_page\030\003 \001(\005b\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_proto_2fsample1_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_proto_2fsample1_2eproto = {
    false, false, 107, descriptor_table_protodef_proto_2fsample1_2eproto,
    "proto/sample1.proto",
    &descriptor_table_proto_2fsample1_2eproto_once, nullptr, 0, 1,
    schemas, file_default_instances, TableStruct_proto_2fsample1_2eproto::offsets,
    file_level_metadata_proto_2fsample1_2eproto, file_level_enum_descriptors_proto_2fsample1_2eproto,
    file_level_service_descriptors_proto_2fsample1_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_proto_2fsample1_2eproto_getter() {
  return &descriptor_table_proto_2fsample1_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_proto_2fsample1_2eproto(&descriptor_table_proto_2fsample1_2eproto);
...
::PROTOBUF_NAMESPACE_ID::Metadata SearchRequest::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_proto_2fsample1_2eproto_getter, &descriptor_table_proto_2fsample1_2eproto_once,
      file_level_metadata_proto_2fsample1_2eproto[0]);
}
